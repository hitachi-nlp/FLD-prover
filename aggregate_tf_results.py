...
def main(input_dir, output_dir, log_level):
    ...
    TF_NAMES = [
        ...
        'eval/extr_stps.D-0.answer_accuracy.zero_one',
        'eval/extr_stps.D-1.answer_accuracy.zero_one',
        'eval/extr_stps.D-2.answer_accuracy.zero_one',
        'eval/extr_stps.D-3.answer_accuracy.zero_one',
        'eval/extr_stps.D-4.answer_accuracy.zero_one',
        'eval/extr_stps.D-5.answer_accuracy.zero_one',
        'eval/extr_stps.D-6.answer_accuracy.zero_one',
        'eval/extr_stps.D-7.answer_accuracy.zero_one',
        'eval/extr_stps.D-8.answer_accuracy.zero_one',
        'eval/extr_stps.D-None.answer_accuracy.zero_one',
        'eval/extr_stps.D-all.answer_accuracy.zero_one',

        'eval/strct.D-0.answer_accuracy.zero_one',
        'eval/strct.D-1.answer_accuracy.zero_one',
        'eval/strct.D-2.answer_accuracy.zero_one',
        'eval/strct.D-3.answer_accuracy.zero_one',
        'eval/strct.D-4.answer_accuracy.zero_one',
        'eval/strct.D-5.answer_accuracy.zero_one',
        'eval/strct.D-6.answer_accuracy.zero_one',
        'eval/strct.D-7.answer_accuracy.zero_one',
        'eval/strct.D-8.answer_accuracy.zero_one',
        'eval/strct.D-None.answer_accuracy.zero_one',
        'eval/strct.D-all.answer_accuracy.zero_one',
    ]
