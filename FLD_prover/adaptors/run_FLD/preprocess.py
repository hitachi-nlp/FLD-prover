...
def preprocess_examples_train(batch_examples: Dict[str, List[Any]]) -> Dict[str, List[Any]]:
    return _preprocess_examples(batch_examples, True)
...
def _preprocess_examples(batch_examples: Dict[str, List[Any]], serialize_stepwise: bool) -> Dict[str, List[Any]]:
    ...
    serialized_examples = [
        serialize(DeductionExample.parse_obj(_example), stepwise=serialize_stepwise)
